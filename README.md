...
- [Kubernetes deployment design](docs/deployment-kubernetes.md): production image, hardened text-only serving template, local/CI checks and operator boundaries; complete production deployment remains pending.
